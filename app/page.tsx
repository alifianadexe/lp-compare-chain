    ...
    <div className="min-h-screen bg-white py-12 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto mb-8">
          <div className="bg-linear-to-r from-blue-50 to-purple-50 border border-gray-200 rounded-xl p-4 shadow-sm">
            <p className="text-sm text-gray-600 text-center mb-3">
              Developed with 💙 by{" "}
              <span className="font-semibold text-gray-900">alifianadexe</span>
            </p>
              ...
              <button
                onClick={() => {
                  navigator.clipboard.writeText(
                    "0xadbfd3a22ca0b3bc5c259b8f1c72be1da6914301d616042270201ea10e5d3e98"
                  );
                ...
                title="Click to copy SUI address"
              >
                <img
